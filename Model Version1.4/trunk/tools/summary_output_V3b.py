...
print("Nman_act_araigl:      %.1f"   %(np.nansum(nman_agri)))
print("Nfer_act_araigl:      %.1f"   %(np.nansum(nfer_agri)))
print("Ndep_var_act_araigl:  %.1f"   %(np.nansum(ndep_var_act_araigl)))
print("Ndep_fix_act_araigl:  %.1f"   %(np.nansum(ndep_fixed_araigl)))
print("Nfix_act_araigl:      %.1f"   %(np.nansum(nfix_araigl)))
print("A_araigl:             %.1f"   %(np.nansum(a_araigl)))
...
print("nman-fer-ha-min: %.1f"         % np.nanmin(nman_fer_ha))
print("nman-fer-crit-sw-ha-min: %.1f" % np.nanmin(nman_fer_crit_sw3_ha))
print("nman-fer-crit-gw-ha-min: %.1f" % np.nanmin(nman_fer_crit_gw3_ha))
print("nman-fer-crit-de-ha-min: %.1f" % np.nanmin(nman_fer_crit_de3_ha))
print("nman-fer-crit-mi-ha-min: %.1f" % np.nanmin(nman_fer_crit_mi3_ha))

print("nman-fer-ha-max: %.1f"         % np.nanmax(nman_fer_ha))
print("nman-fer-crit-sw-ha-max: %.1f" % np.nanmax(nman_fer_crit_sw3_ha))
print("nman-fer-crit-gw-ha-max: %.1f" % np.nanmax(nman_fer_crit_gw3_ha))
print("nman-fer-crit-de-ha-max: %.1f" % np.nanmax(nman_fer_crit_de3_ha))
print("nman-fer-crit-mi-ha-max: %.1f" % np.nanmax(nman_fer_crit_mi3_ha))
